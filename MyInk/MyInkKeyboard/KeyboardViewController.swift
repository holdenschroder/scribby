...
class KeyboardViewController: UIInputViewController {
    ...
    func handleProxyConsumerComplete(_ message:String) -> Void {
        ...
        if(message.characters.count > 0) {
            ...
            let messageImage = _messageRenderer!.renderMessage(message, imageSize: CGSize(width: 440, height: 4096), lineHeight: 32, backgroundColor: beigeMessageBackgroundColor, showDebugInfo: false, maxLineWidth: 440)
            if messageImage != nil {
